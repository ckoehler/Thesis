...
effort was put into finding well-performing NLFM waveforms, the simulations favor an amplitude tapered LFM waveform with
sidelobes around \SI{-70}{\decibel}, with the only drawback being a \SI{3}{\decibel} loss in energy.
...
to perhaps find waveforms that perform better for weather radar applications than the examined NLFM sweep
functions.
