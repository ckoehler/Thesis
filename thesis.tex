...
Most of the literature about radar waveforms has been done in the context of application other than weather. 
This thesis will focus the discussion of radar waveforms on weather radar applications. Pulse compression is especially
interesting for weather radar applications because it achieves better range resolution.
In particular, rectangular pulses, linear frequency modulation, and non-linear frequency modulated signals will be examined in regards to their
ambiguity function.  Each will be quantified in respect to integrated sidelobe level, maximum sidelobe level, and range
resolution. Further, amplitude tapering will be applied to determine its performance benefits. For non-linear frequency
modulated waveforms, the frequency sweep function is parameterized and optimal values for weather applications are
presented.
\end{preface}
