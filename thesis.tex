...
\prefacesection{Abstract}
 ...
 weather. This paper will focus the discussion of radar waveforms on weather radar applications. In 
 particular, rectangular pulses, linear frequency modulation, and non-linear frequency modulated
 signals will be examined in regards to their ambiguity function. 
 Each will be quantified in respect to integrated sidelobe level, maximum
 sidelobe level, and range resolution. Further, amplitude tapering will be applied to determine its
 performance benefits. For non-linear frequency modulated waveforms, the frequency sweep function is
 parameterized and optimal values for weather applications are presented.
\end{preface}
