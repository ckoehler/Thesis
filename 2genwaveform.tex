...
differently, such that the received echoes can be assigned to a certain pulse. That way, an echo from the first
...
rectangular pulse determines the bandwidth of the signal. More specifically, the bandwidth B is the inverse of the pulse
length $\tau$.
