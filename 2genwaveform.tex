...
\caption{A basic waveform showing amplitude, period, phase, and PRT. Each component is explained in
...
appear to move slower or faster than they actually do. }
...
\SI{25}{\metre\per\second} in the opposite direction.
...
\caption{DRAFT: ACF of a rectangular pulse. Similar to the convolution, the output of the matched filter of a
