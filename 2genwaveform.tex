...
That means that, for a large PRT, the unambiguous velocity will be low and velocity aliasing will become more likely.
...
The previous techniques were independent of the pulse length. However, pulse length does affect the performance of the
radar.
...
also decrease range resolution. Depending on the application, simply increasing the pulse length to increase 
sensitivity may not be a desirable solution.
In this work, the pulse length is denoted by $T$.
