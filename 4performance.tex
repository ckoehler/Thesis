...
where $u(t)$ is the complex envelope of the signal, $\tau$ is the delay due to propagation, not to be confused with the pulse
length used in other places, and $f_d$ is the Doppler frequency in the Doppler axis.
