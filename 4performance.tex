...
It can clearly be be be seen that, for $f_d = 0$, the AF reduces to the Autocorrelation Function (ACF).
...
All this said, the simulations in this work will show in Chapter \ref{chap:optimization} that for weather radar applications, the Doppler mismatch can be safely ignored for the low velocities
of most observed weather phenomena.
...
is \SI{93}{\decibel}. However, that means that weaker return signals, e.g. rain at \SI{15}{\decibel}Z, only get about \SI{20}{\percent}
