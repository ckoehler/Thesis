...
to compute the ambiguity function is presented, with the complete code given in Appendix \ref{app:code}.
...
\caption{Amplitude tapering optimization results for a Barker 13 code }
\label{fig:barker13-15us-opti}
\includegraphics[width=\imgsize]{figures/barker-15us-opti-slice3.png}
\caption{Zero-Doppler slice at $\beta=1.026$}
...
For each function, a waveform and ambiguity functions are generated and then evaluated according to the optimizations
...
\caption{PSL optimization results for NLFM combined with Kaiser amplitude tapering}
...
Figure \ref{fig:pulsewir-15us} shows the AF for a pulse that has been distorted by the transfer function shown in figure
