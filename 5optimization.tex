...
about \SI{-22}{\decibel} \citep[p. 351]{Skolnik:2001}. The range resolution is approximately 110 m at the
\SI{3}{\decibel} point.
...
pulse length has little effect on the range resolution, which is approximately 30 m. Instead, range resolution is determined by the sweep bandwidth,
