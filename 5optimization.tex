...
is varied from 0 to 50 in 1.0 increments, and the AF generated and evaluated for each by quantifying its performance according to the
...
The corresponding zero Doppler cut of the AF at this point is shown in figure \ref{fig:lfm-isl-15us-opti-slice8}. It
...
\begin{figure}[H]
\includegraphics[width=\imgsize]{figures/lfm-isl-15us-opti-slice8.png}
...
\label{fig:lfm-isl-15us-opti-slice8}
\end{figure}
