...
Kaiser window with different values of $\beta$ to the Barker 13 signal. It shows that both ISL and MSL generally become worse with increased
...
fantastic. The maximum ISL is around \SI{-15}{\decibel}. The MSL decreases rapidly first to about 
