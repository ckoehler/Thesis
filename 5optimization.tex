...
\caption{ AF of a rectangular pulse of length 1 $\mu s$. There is no significant Doppler mismatch for typical velocities of
weather phenomena.}
...
\section{Barker Code}
In this section, a length 13 Barker code of different pulse lengths will be examined. Figures \ref{fig:barker13-1us} and
...
TODO: expand on the wave passing through system.
...
\subsection{Linear Frequency Modulation}
Figure \ref{fig:lfmwir-15us} shows the AF of an LFM waveform with pulse length $\tau=\SI{15}{\micro\second}$. The
distortion of the impulse response smoothes out the sidelobes on one side of the AF in the range delay direction.
\begin{figure}[H]
...
Figure \ref{fig:lfmwir-15us} shows the AF of an NLFM waveform with pulse length $\tau=\SI{15}{\micro\second}$. Compared
to the LFM waveform discussed previously, the distortion of the impulse response does not smooth the sidelobes out
completely on one side, although they are smoother than the other side.
\begin{figure}[H]
