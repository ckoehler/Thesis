...
variables are derived,e.g., $Z_{dr}$, the differential reflectivity, or $\rho_{hv}$, the correlation coefficient, and
$\Phi_{dp}$, the differential phase. They are mostly used for hydrometeor classification and Quantitative Precipitation
...
or magentron, a phased array radar can incorporate amplifier modules into the antenna element to power each one
...
TODO: find bell lab's paper on pulse compression.
