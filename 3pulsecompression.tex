...
In this work, the Kaiser window is chosen because it allows for its shape to be changed based on one parameter $\alpha$. Evaluating 
the different waveforms for various values of $\alpha$ allows optimizing the amplitude tapering for weather application.
...
For the sake of simplicity, the parameter is redefined as $\beta = \pi \alpha$ to make the function
